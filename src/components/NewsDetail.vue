    ...
    <div style="width: 834px; margin-right: 30px"><h2 class="article-title">
      ...
      <div class="comment-wrap" style="padding-bottom: 300px">
        <div style="display: flex">
          <div style="width: 42px; height: 42px; border-radius: 42px; overflow: hidden"><img width="100%"
                                                                                             alt=""
          >
          </div>
          <div style="width: 100%; margin-left: 24px; border: 1px solid #E8E8E8">
            <div style="height: 48px; padding: 0 25px"><input placeholder="写下您的评论..."
        ...
        <ul style="margin-top: 20px"> <!--v-for-start--><!--v-for-end--> </ul> <!--fragment-start-->
        <div class="deal-wrap" style="text-align: center"><img style="margin-top: 92px"
                                                               ...
                                                               width="272" height="185" alt=""> <span
          class="null-text">还没有人评论，赶紧来抢沙发吧！！</span></div><!--v-component--><!--fragment-end--><!--v-if-->
      </div>
    </div>
  </div>
</template>
